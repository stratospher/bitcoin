...
class TestNode():
    ...
    def add_p2p_connection(self, p2p_conn, *, wait_for_verack=True, support_v2_p2p=False, advertise_v2_p2p=False, **kwargs):
        ...
        Parameters:
            ...
            advertise_v2_p2p: whether TestNode is advertised to support v2 p2p connection or not
        """
    ...
    def add_outbound_p2p_connection(self, p2p_conn, *, p2p_idx, connection_type="outbound-full-relay", support_v2_p2p=False, advertise_v2_p2p=False, **kwargs):
