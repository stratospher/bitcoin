...
class TestNode():
    ...
    def add_p2p_connection(self, p2p_conn, *, wait_for_verack=True, supports_v2_p2p=False, **kwargs):
        ...
        p2p_conn.peer_connect(**kwargs, net=self.chain, timeout_factor=self.timeout_factor, supports_v2_p2p=supports_v2_p2p)()
