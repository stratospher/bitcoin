...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def connect_nodes(self, a, b, peer_advertises_v2=False):
        ...
        def check_initiator_handshake():
            ...
            return responder['version'] != 0 and responder['bytesrecv_per_msg'].pop('verack', 0) >= min_verack_msg_bytes
        ...
        def check_responder_handshake():
            ...
            return initiator['version'] != 0 and initiator['bytesrecv_per_msg'].pop('verack', 0) >= min_verack_msg_bytes
