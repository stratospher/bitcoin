...
SHORTID = {
    ...
    27 : b"cfcheckpt",
    28 : b"addrv2",
    29 : b"reqrecon",#TODO: reqrecon, sketch, reqsketchext, reconcildiff are not present in messages.py
    30 : b"sketch",
    31 : b"reqsketchext",
    32 : b"reconcildiff",
}
...
class EncryptedP2PState:
    ...
    def authenticate_handshake(self, response):
        ...
        Marks the v2 handshake as complete and returns True if the authentication was successful.
        Done by both initiator and responder."""
