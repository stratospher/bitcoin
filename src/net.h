...
public:
    ...
    /** Returns true if both outbound and inbound connections to IPv4/IPv6 peers must be v2 only. */
...
private:
    ...
    /**
     * option for restricting clearnet connections (IPv4/IPv6) to v2 only.
     * both outbound and inbound connections on IPV4/IPV6 need to be v2 connections.
     * both outbound and inbound connections on Tor/I2P/CJDNS can be v1 or v2 connections.
     */
