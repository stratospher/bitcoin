...
public:
    V2TransportDeserializer(const NodeId node_id,
        ...
        : m_cipher_suite(new BIP324CipherSuite(key_l, key_p)),
          m_node_id(node_id),
...
public:
     ...
     */
    bool AddConnection(const std::string& address, ConnectionType conn_type, const bool use_p2p_v2) EXCLUSIVE_LOCKS_REQUIRED(!m_total_bytes_sent_mutex);
