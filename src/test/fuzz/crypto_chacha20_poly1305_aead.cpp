...
FUZZ_TARGET(crypto_chacha20_poly1305_aead)
{
    ...
    std::vector<unsigned char> k1 = ConsumeFixedLengthByteVector(fuzzed_data_provider, CHACHA20_POLY1305_AEAD_KEY_LEN);
    std::vector<unsigned char> k2 = ConsumeFixedLengthByteVector(fuzzed_data_provider, CHACHA20_POLY1305_AEAD_KEY_LEN);

    ChaCha20Poly1305AEAD aead(k1, k2);
