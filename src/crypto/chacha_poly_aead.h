...
{
private:
    ChaCha20Forward4064 m_chacha_header; // AAD cipher instance (encrypted length)
    ChaCha20Forward4064 m_chacha_main;   // payload and poly1305 key-derivation cipher instance
